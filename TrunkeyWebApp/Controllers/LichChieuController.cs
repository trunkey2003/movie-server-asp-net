...
namespace TrunkeyWebApp.Controllers
{
    public class LichChieuController : Controller
    {
        ...
        public LichChieuController(movie_server_cybersoftContext context, Middlewares.IAuthorization Authorization)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var movie_server_cybersoftContext = _context.LichChieus.Include(l => l.MaPhimNavigation).Include(l => l.MaRapNavigation);
